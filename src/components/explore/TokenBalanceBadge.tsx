...
/**
 * The signed-in user's TALE balance, with a faucet claim.
 *
 * There is no ui/badge.tsx in this project, and the explore/ surface hand-rolls
 * its chrome, so this is a styled span in the same editorial idiom as
 * CompetitionCard's overline rather than a new shadcn primitive.
 */
