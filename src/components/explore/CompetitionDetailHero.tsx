...
export function CompetitionDetailHero({
  ...
  return (
    <div className="relative overflow-hidden py-11 border-b border-ns-border">
      ...
      />
      <div className="relative flex flex-col lg:flex-row gap-11 items-start">
        <CompetitionCover competition={competition} size="hero" className="hidden md:flex shrink-0" />
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center flex-wrap gap-3 mb-5">
            ...
            <span className="font-ui text-[10px] font-bold uppercase tracking-[0.22em] text-ns-accent">
              {countdown.isPast ? phaseLabel : `${phaseLabel} · Closes in ${countdown.label}`}
            </span>
